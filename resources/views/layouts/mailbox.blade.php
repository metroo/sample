...
@section('sidebar')
    @include('layouts.sidebar', ['page'=>'mailboxIndex'])
@endsection
...
@section('adminlte_js')
    <script>
         $(document).ready(function(){
            fetch_user_chat_id = -1; chat_timestamp = '';
            fetch_user(fetch_user_chat_id);
            ...
            function fetch_user(id)
            {
                $.ajax({
                    ...
                    url:"{{ url('dashboard/mailbox/fetch_user') }}/"+id,
                    method:"POST",
            ...
            function fetch_user_chat(id)
            {
                $.ajax({
                    ...
                    url:"{{ url('dashboard/mailbox/fetch_user_chat') }}/"+id,
                    method:"POST",
                    success:function(data){
                        console.log(data[0])
            ...
            $('#chat_form').submit(function(e) {
                ...
                $.ajax({
                    ...
                    url:"{{ url('dashboard/mailbox/send_chat') }}/"+fetch_user_chat_id,
