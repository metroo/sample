...
@section('sidebar')
    @include('admin.sidebarAdmin' , ['page'=>'sound-multimedia'])
@endsection

@section('contentHeader')
    @include('admin.contentheader' , ['header' => 'صوت جدید' ])
@endsection
...
@section('adminlte_js')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#soundImage_selectfileBtn').on('click' ,function () {
                showModalUploader.initialize({
                    publicUrl : '{{Url('')}}' ,
                    csrf : '@csrf' ,
                    acceptedFiles : 'image',
                    formFieldId : '#soundImage_formFieldId' ,
                    palceImageId : '#soundImage_palceImageId',
                    formFieldUrl : '#soundImage_formFieldUrl'
                });
                showModalUploader.show();
            });
            $('#soundFile_selectfileBtn').on('click' ,function () {
                showModalUploader.initialize({
                    publicUrl : '{{Url('')}}' ,
                    csrf : '@csrf' ,
                    acceptedFiles : 'sound',
                    maxFilesize : 10,
                    formFieldId : '#soundFile_formFieldId' ,
                    palceImageId : '#soundFile_palceFileId',
                    formFieldUrl : '#soundFile_formFieldUrl'
                });
                showModalUploader.show();
            });
...
@section('content')
    <div class="content">
            <div class="col-md-12">
                ...
                @endif
                        <div class="col">
                            <form action="{{Url('admin/sound')}}"  method="POST" id="createForm">
                                @csrf
                                                ...
                                                <div class="row">
                                                        ...
                                                        <div class="card ">
                                                            <div class="card-header">
                                                                <div class="row">
                                                                    ...
                                                                    <input type="text" id="soundImage_formFieldId" name="soundImage_formFieldId"
                                                                    ...
                                                                    <div class="col-sm-12 ">
                                                                        <div class="input-group mb-3">
                                                                            ...
                                                                            <input style="direction: ltr!important;"  type="text"
                                                                                   id="soundImage_formFieldUrl" name="soundImage_formFieldUrl"
                                                                                   type="text" class="form-control" placeholder="آدرس فایل">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-sm-12 ">
                                                                    <span class="mailbox-attachment-icon" id="soundImage_palceImageId">
                                                                        <i class="far fa-file-image"></i></span>
                                                                </div>
                                                            </div>
                                                            <!-- /.card-body -->
                                                            <div class="card-footer">
                                                                 <span   id="soundImage_selectfileBtn"
                                                    ...
                                                    <div class=" col-sm-12 col-md-6">
                                                         ...
                                                         <div class="card-header ">
                                                            ...
                                                            </h3>  <input type="text" id="soundFile_formFieldId" name="soundFile_formFieldId"
                                                        ...
                                                        <div class="card-body row">
                                                            <div class="col-sm-12 ">
                                                                <div class="input-group mb-3">
                                                                    ...
                                                                    <!-- /btn-group -->
                                                                    <input style="direction: ltr!important;"  type="text"
                                                                           id="soundFile_formFieldUrl" name="soundFile_formFieldUrl"
                                                                           type="text" class="form-control" placeholder="آدرس فایل">
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-12 ">
                                                                    <span class="mailbox-attachment-icon" id="soundFile_palceFileId">
                                                                        <i class="far fa-file-image"></i></span>
                                                            </div>
                                                        </div>
                                                        <!-- /.card-body -->
                                                        <div class="card-footer">
                                                             <span   id="soundFile_selectfileBtn"
                                                                     class=" li-modal btn btn-info btn-sm float-right">
                                                                <i class="fas fa-cloud-upload-alt"></i>
                                                            انتخاب فایل</span>
                                                        </div>
                                                    ...
                                                    <div class="col-sm-10">
                                                        <div class="input-group  " style="direction: ltr!important;">
                                                            <div class="input-group-append"  style="direction: ltr!important;">
                                                                <span class="input-group-text" style="direction: ltr!important;">http://banifatemeh.org/sound/</span>
                                                            </div>
