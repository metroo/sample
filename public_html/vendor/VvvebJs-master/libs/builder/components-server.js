...
Vvveb.ComponentsGroup['کامپوننت های سرور'] = ["components/product21","components/products11", "components/product11", "components/categories", "components/manufacturers", "components/search", "components/user", "components/product_gallery", "components/cart", "components/checkout", "components/filters", "components/product", "components/slider"];

Vvveb.Components.add( "components/product21", {
	 image: "icons/map.svg",
     name: "لیست محصولات",
	attributes: ["data-component-product-list"],
	  html: '<div  data-component-product-list style="bgColor:red;height:50px;width:98%;"> \
...
Vvveb.Components.add("components/product11", {
    name: "Product محصول",
    attributes: ["data-component-product"],

    image: "icons/map.svg", 
	html: '<div  data-component-product style="bgColor:red;height:50px;width:98%;"> \
			<div class="fb-comments"  \
			data-id="5" \
			data-colorscheme="light" \
			data-mobile="" \
...
Vvveb.Components.add("components/products11", {
    name: "Products",
    attributes: ["data-component-products"],

    image: "icons/products.svg",
     html: '<div  data-component-products style="bgColor:red;height:50px;width:98%;"> \
			<div class="fb-comments"  \
			data-numposts="5" \
			data-colorscheme="light" \
			data-mobile="" \
...
Vvveb.Components.add("components/manufacturers", {
	attributes: ["data-component-manufacturers"],
    name: "Manufacturers",
    image: "icons/categories.svg",
    html: '<div data-component-manufacturers>\
			<div class="fb-page11" data-category="asd" data-hide-cover="true">\
